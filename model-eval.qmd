...
## Current recommendation: OpenAI o4-mini, Claude Sonnet 3.7, or OpenAI o3
...
**For R coding tasks, we recommend using OpenAI's o4-mini or Anthropic's Claude Sonnet 3.7.** OpenAI's o3 performed the best on this evaluation, but is also ten times more expensive than o4-mini and around three times more expensive than Sonnet 3.7 (see pricing table below).
