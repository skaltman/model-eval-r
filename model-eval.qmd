...
Reasoning models, including o4-mini, often generate significantly more output tokens than non-reasoning models. So while o4-mini is inexpensive per token, its actual cost can be higher than expected.  
...
A **token** is the fundamental unit of data that an LLM can process. For text processing, you can think of a token as approximately a word, although it may be smaller. 
